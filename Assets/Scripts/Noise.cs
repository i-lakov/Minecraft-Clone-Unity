...
public static class Noise
{
    ...
    {
        float x = (position.x + VoxelData.seed + offset + 0.1f) * scale;
        float y = (position.y + VoxelData.seed + offset + 0.1f) * scale;
        float z = (position.z + VoxelData.seed + offset + 0.1f) * scale;
